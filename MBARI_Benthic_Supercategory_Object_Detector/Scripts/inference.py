...
# WEIGHTS_FILE - Path to the Models with fathomnet weights
# NMS_THRESH - Set a nms threshold for the all boxes results
# SCORE_THRESH - This is where you can set the Models score threshold

CONFIG_FILE = "../Resources/fathomnet_config_v2_1280.yaml"
WEIGHTS_FILE = "../Models/model_final.pth"
NMS_THRESH = 0.45  #
SCORE_THRESH = 0.3  #
...
# This is where the Models parameters are instantiated. There is a LOT of
...
# Loading of the Models weights, but more importantly this is where the Models
...
def run_inference(test_image):
    ...
    Models, which will output bounding boxes and class categories for each
    ...
    # augmentation: do the augmentation, run the Models, perform nms
    ...
    for augmentation in augmentations:
        ...
        # pass to Models, which outputs a dict containing info on all detections
        with torch.no_grad():
    ...
    # Concatenate the Models outputs and run NMS thresholding on all output;
